...
int main(int argc, char **argv) {
    ...
    // Essentially in our program we have malloc'ed memory for the following:
    // wordle, solver_node, solver_node constraints, dict.
    // We can simply free each of these as follows
    // Notice that free_tree free's all the mallocs to solver_node struct and also constraints
    free_tree(word_tree);
